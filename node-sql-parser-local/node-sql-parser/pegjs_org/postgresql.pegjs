...
create_func_opt_B
  = 'LANGUAGE' __ ident_name __'IMMUTABLE'* __ 'AS' __ '$_$'.+'$_$' 
  / 'LANGUAGE' __ ident_name __'IMMUTABLE'* __ 'AS' __ '$$'.+'$$' 

create_func_opt_A
  = 'LANGUAGE' __ ident_name __'IMMUTABLE'* __ 'AS $_$' __ .+ __ '$_$' 
  / 'LANGUAGE' __ ident_name __'IMMUTABLE'* __ 'AS $$' __ .+ __ '$$' 
...
create_func_opt_org
  ...
  / KW_AS __ c:[^ \s\t\n\r]+ __ de:declare_stmt? __ b:('BEGIN'i)? __ s:multiple_stmt __ e:KW_END? &{ return (b && e) || (!b && !e) } __ SEMICOLON? __ l:[^ \s\t\n\r;]+ __ {
    ...
    const start = c.join('')
    const end = l.join('')
    //GUSA if (start !== end) throw new Error(`start symbol '${start}'is not same with end symbol '${end}'`)
    return {
      type: 'as',
      declare: de && de.ast,
      begin: b,
...
create_function_stmt
  ...
  r:func_returns? __
  //GUSA fo:create_func_opt* __ SEMICOLON? __ { 
  //fo:create_func_opt* __   {
  fo:create_func_opt* __   {
    /*
